...
use crate::utils::{i8_str, to_val_str};
use std::os::raw::c_void;
use std::ptr;
use crate::api_initialized::ApiInitialized;
...
header_fields!(189;
    // Shared
    {hf_kafka_error, "Error\0", "kafka.error\0", ftenum_FT_INT16, "Kafka broker error.\0", kafka_errors},
    ...
    {hf_kafka_request_api_key, "API Key\0", "kafka.request_key\0", ftenum_FT_INT16, "Request API.\0", api_keys},
    ...
    {hf_kafka_batch_compression {
        p_id: unsafe { hf_kafka_batch_compression.ptr_for_api_init() },
    ...
    {hf_kafka_batch_timestamp_type {
        p_id: unsafe { hf_kafka_batch_timestamp_type.ptr_for_api_init() },
        hfinfo: header_field_info {
    ...
    {hf_kafka_batch_istransactional {
        p_id: unsafe { hf_kafka_batch_istransactional.ptr_for_api_init() },
        hfinfo: header_field_info {
    ...
    {hf_kafka_batch_iscontrolbatch {
        p_id: unsafe { hf_kafka_batch_iscontrolbatch.ptr_for_api_init() },
        hfinfo: header_field_info {
    ...
    {hf_kafka_messageset_compression {
        p_id: unsafe { hf_kafka_messageset_compression.ptr_for_api_init() },
        hfinfo: header_field_info {
            name: i8_str("Compression\0"),
    ...
    {hf_kafka_messagest_timestamp_type {
        p_id: unsafe { hf_kafka_messagest_timestamp_type.ptr_for_api_init() },
        hfinfo: header_field_info {
            name: i8_str("Timestamp type\0"),
...
pub(crate) static mut kafka_batch_attributes: [*const i32; 5] = [
    unsafe {hf_kafka_batch_compression.ptr_for_api_init()},
    unsafe {hf_kafka_batch_timestamp_type.ptr_for_api_init()},
    unsafe {hf_kafka_batch_istransactional.ptr_for_api_init()},
    unsafe {hf_kafka_batch_iscontrolbatch.ptr_for_api_init()},
    0 as *const i32,
];

pub(crate) static mut kafka_messageset_attributes: [*const i32; 3] = [
    unsafe {hf_kafka_messageset_compression.ptr_for_api_init()},
    unsafe {hf_kafka_messagest_timestamp_type.ptr_for_api_init()},
    0 as *const i32,
];
...
pub(crate) static api_keys: [value_string; 44] = [
    to_val_str((0, "Produce\0")),
    to_val_str((1, "Fetch\0")),
    to_val_str((2, "ListOffsets\0")),
    to_val_str((3, "Metadata\0")),
    to_val_str((4, "LeaderAndIsr\0")),
    to_val_str((5, "StopReplica\0")),
    to_val_str((6, "UpdateMetadata\0")),
    to_val_str((7, "ControlledShutdown\0")),
    to_val_str((8, "OffsetCommit\0")),
    to_val_str((9, "OffsetFetch\0")),
    to_val_str((10, "FindCoordinator\0")),
    to_val_str((11, "JoinGroup\0")),
    to_val_str((12, "Heartbeat\0")),
    to_val_str((13, "LeaveGroup\0")),
    to_val_str((14, "SyncGroup\0")),
    to_val_str((15, "DescribeGroups\0")),
    to_val_str((16, "ListGroups\0")),
    to_val_str((17, "SaslHandshake\0")),
    to_val_str((18, "ApiVersions\0")),
    to_val_str((19, "CreateTopics\0")),
    to_val_str((20, "DeleteTopics\0")),
    to_val_str((21, "DeleteRecords\0")),
    to_val_str((22, "InitProducerId\0")),
    to_val_str((23, "OffsetForLeaderEpoch\0")),
    to_val_str((24, "AddPartitionsToTxn\0")),
    to_val_str((25, "AddOffsetsToTxn\0")),
    to_val_str((26, "EndTxn\0")),
    to_val_str((27, "WriteTxnMarkers\0")),
    to_val_str((28, "TxnOffsetCommit\0")),
    to_val_str((29, "DescribeAcls\0")),
    to_val_str((30, "CreateAcls\0")),
    to_val_str((31, "DeleteAcls\0")),
    to_val_str((32, "DescribeConfigs\0")),
    to_val_str((33, "AlterConfigs\0")),
    to_val_str((34, "AlterReplicaLogDirs\0")),
    to_val_str((35, "DescribeLogDirs\0")),
    to_val_str((36, "SaslAuthenticate\0")),
    to_val_str((37, "CreatePartitions\0")),
    to_val_str((38, "CreateDelegationToken\0")),
    to_val_str((39, "RenewDelegationToken\0")),
    to_val_str((40, "ExpireDelegationToken\0")),
    to_val_str((41, "DescribeDelegationToken\0")),
    to_val_str((42, "DeleteGroups\0")),
    to_val_str((43, "ElectLeaders\0")),
];

pub(crate) static kafka_errors: [value_string; 78] = [
    to_val_str((-1, "UNKNOWN_SERVER_ERROR\0")),
    to_val_str((0, "NONE\0")),
    to_val_str((1, "OFFSET_OUT_OF_RANGE\0")),
    to_val_str((2, "CORRUPT_MESSAGE\0")),
    to_val_str((3, "UNKNOWN_TOPIC_OR_PARTITION\0")),
    to_val_str((4, "INVALID_FETCH_SIZE\0")),
    to_val_str((5, "LEADER_NOT_AVAILABLE\0")),
    to_val_str((6, "NOT_LEADER_FOR_PARTITION\0")),
    to_val_str((7, "REQUEST_TIMED_OUT\0")),
    to_val_str((8, "BROKER_NOT_AVAILABLE\0")),
    to_val_str((9, "REPLICA_NOT_AVAILABLE\0")),
    to_val_str((10, "MESSAGE_TOO_LARGE\0")),
    to_val_str((11, "STALE_CONTROLLER_EPOCH\0")),
    to_val_str((12, "OFFSET_METADATA_TOO_LARGE\0")),
    to_val_str((13, "NETWORK_EXCEPTION\0")),
    to_val_str((14, "COORDINATOR_LOAD_IN_PROGRESS\0")),
    to_val_str((15, "COORDINATOR_NOT_AVAILABLE\0")),
    to_val_str((16, "NOT_COORDINATOR\0")),
    to_val_str((17, "INVALID_TOPIC_EXCEPTION\0")),
    to_val_str((18, "RECORD_LIST_TOO_LARGE\0")),
    to_val_str((19, "NOT_ENOUGH_REPLICAS\0")),
    to_val_str((20, "NOT_ENOUGH_REPLICAS_AFTER_APPEND\0")),
    to_val_str((21, "INVALID_REQUIRED_ACKS\0")),
    to_val_str((22, "ILLEGAL_GENERATION\0")),
    to_val_str((23, "INCONSISTENT_GROUP_PROTOCOL\0")),
    to_val_str((24, "INVALID_GROUP_ID\0")),
    to_val_str((25, "UNKNOWN_MEMBER_ID\0")),
    to_val_str((26, "INVALID_SESSION_TIMEOUT\0")),
    to_val_str((27, "REBALANCE_IN_PROGRESS\0")),
    to_val_str((28, "INVALID_COMMIT_OFFSET_SIZE\0")),
    to_val_str((29, "TOPIC_AUTHORIZATION_FAILED\0")),
    to_val_str((30, "GROUP_AUTHORIZATION_FAILED\0")),
    to_val_str((31, "CLUSTER_AUTHORIZATION_FAILED\0")),
    to_val_str((32, "INVALID_TIMESTAMP\0")),
    to_val_str((33, "UNSUPPORTED_SASL_MECHANISM\0")),
    to_val_str((34, "ILLEGAL_SASL_STATE\0")),
    to_val_str((35, "UNSUPPORTED_VERSION\0")),
    to_val_str((36, "TOPIC_ALREADY_EXISTS\0")),
    to_val_str((37, "INVALID_PARTITIONS\0")),
    to_val_str((38, "INVALID_REPLICATION_FACTOR\0")),
    to_val_str((39, "INVALID_REPLICA_ASSIGNMENT\0")),
    to_val_str((40, "INVALID_CONFIG\0")),
    to_val_str((41, "NOT_CONTROLLER\0")),
    to_val_str((42, "INVALID_REQUEST\0")),
    to_val_str((43, "UNSUPPORTED_FOR_MESSAGE_FORMAT\0")),
    to_val_str((44, "POLICY_VIOLATION\0")),
    to_val_str((45, "OUT_OF_ORDER_SEQUENCE_NUMBER\0")),
    to_val_str((46, "DUPLICATE_SEQUENCE_NUMBER\0")),
    to_val_str((47, "INVALID_PRODUCER_EPOCH\0")),
    to_val_str((48, "INVALID_TXN_STATE\0")),
    to_val_str((49, "INVALID_PRODUCER_ID_MAPPING\0")),
    to_val_str((50, "INVALID_TRANSACTION_TIMEOUT\0")),
    to_val_str((51, "CONCURRENT_TRANSACTIONS\0")),
    to_val_str((52, "TRANSACTION_COORDINATOR_FENCED\0")),
    to_val_str((53, "TRANSACTIONAL_ID_AUTHORIZATION_FAILED\0")),
    to_val_str((54, "SECURITY_DISABLED\0")),
    to_val_str((55, "OPERATION_NOT_ATTEMPTED\0")),
    to_val_str((56, "KAFKA_STORAGE_ERROR\0")),
    to_val_str((57, "LOG_DIR_NOT_FOUND\0")),
    to_val_str((58, "SASL_AUTHENTICATION_FAILED\0")),
    to_val_str((59, "UNKNOWN_PRODUCER_ID\0")),
    to_val_str((60, "REASSIGNMENT_IN_PROGRESS\0")),
    to_val_str((61, "DELEGATION_TOKEN_AUTH_DISABLED\0")),
    to_val_str((62, "DELEGATION_TOKEN_NOT_FOUND\0")),
    to_val_str((63, "DELEGATION_TOKEN_OWNER_MISMATCH\0")),
    to_val_str((64, "DELEGATION_TOKEN_REQUEST_NOT_ALLOWED\0")),
    to_val_str((65, "DELEGATION_TOKEN_AUTHORIZATION_FAILED\0")),
    to_val_str((66, "DELEGATION_TOKEN_EXPIRED\0")),
    to_val_str((67, "INVALID_PRINCIPAL_TYPE\0")),
    to_val_str((68, "NON_EMPTY_GROUP\0")),
    to_val_str((69, "GROUP_ID_NOT_FOUND\0")),
    to_val_str((70, "FETCH_SESSION_ID_NOT_FOUND\0")),
    to_val_str((71, "INVALID_FETCH_SESSION_EPOCH\0")),
    to_val_str((72, "LISTENER_NOT_FOUND\0")),
    to_val_str((73, "TOPIC_DELETION_DISABLED\0")),
    to_val_str((74, "FENCED_LEADER_EPOCH\0")),
    to_val_str((75, "UNKNOWN_LEADER_EPOCH\0")),
    to_val_str((76, "UNSUPPORTED_COMPRESSION_TYPE\0")),
];